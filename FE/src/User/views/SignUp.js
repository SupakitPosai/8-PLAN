...
export default class SignUp extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <Container
          style={{ paddingTop: "7rem", backgroundImage: `url(${Background})` }}
        >
          <form
            onSubmit={(e) => {
              e.preventDefault();
              ...
              <Col sm={6}>
                <div className="csignin csignup">
                  ...
                  <div className="inputbox">
                    ...
                    />
                    <label htmlFor="username">กรอกรหัสผ่านอีกครั้ง : </label>
                  </div>
                  <Alert
                    style={divStyle2}
                    key="sdfdsaf"
              ...
              <Col>
                <div className="csignin csignup">
                  ...
                  <div className="inputbox">
                    ...
                    />
                    <label htmlFor="username">อีเมล์ : </label>
                  </div>
                  <Alert
                    style={divStyle3}
                    key="fewfw"
                  ...
                  <div className="inputbox">
                    ...
                    />
                    <label htmlFor="username">ที่อยู่ : </label>
                  </div>
